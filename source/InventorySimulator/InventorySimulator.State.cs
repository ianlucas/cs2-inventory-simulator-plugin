...
public partial class InventorySimulator
{
    ...
    public readonly FakeConVar<bool> invsim_validation_enabled = new("invsim_validation_enabled", "Whether to validate player's inventory was fetched before spawning.", false);
