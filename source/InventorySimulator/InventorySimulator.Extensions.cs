...
public static class Extensions
{
    ...
    public static readonly MemoryFunctionWithReturn<IntPtr, string, int> ChangeSubclassMemFunc =
        new(GameData.GetSignature("ChangeSubclass"));

    public static readonly Func<nint, string, int> ChangeSubclassFunc =
        ChangeSubclassMemFunc.Invoke;
    ...
    public static readonly MemoryFunctionWithReturn<
        ...
        float,
        int
    > SetOrAddAttributeValueByNameMemFunc = new(
        GameData.GetSignature("CAttributeList_SetOrAddAttributeValueByName")
    );

    public static readonly Func<IntPtr, string, float, int> SetOrAddAttributeValueByNameFunc =
        SetOrAddAttributeValueByNameMemFunc.Invoke;
    ...
    public static readonly Func<IntPtr, string, int, int> SetBodygroupFunc =
        SetBodygroupMemFunc.Invoke;
    ...
    public static readonly MemoryFunctionWithReturn<
        ...
        IntPtr,
        IntPtr
    > IsAbleToApplySprayMemFunc = new(GameData.GetSignature("CCSPlayerPawn_IsAbleToApplySpray"));

    public static readonly Func<IntPtr, IntPtr, IntPtr, IntPtr, IntPtr> IsAbleToApplySprayFunc =
        IsAbleToApplySprayMemFunc.Invoke;
    ...
    public static readonly MemoryFunctionWithReturn<
        ...
        bool,
        float
    > ProcessUsercmds = new(GameData.GetSignature("CCSPlayerController_ProcessUsercmds"));
    ...
    public static int SetOrAddAttributeValueByName(
        this CAttributeList attributeList,
